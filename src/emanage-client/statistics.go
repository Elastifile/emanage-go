...
func (s *Statistic) GetUsedPercentage() (float64, error) {
	...
	logger.Info("GetUsedPrecentage",
		"Free Capacity", size.Size(freeCapacity),
		"Capacity", size.Size(capacity),
		"Self Healing WM", size.Size(selfHealingWM),
	)
	if selfHealingWM > 0 {
...
func (s *statistics) GetFull(entryId int) (statFullRes, error) {
