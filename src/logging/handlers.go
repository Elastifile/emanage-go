...
func getDefaultHandlers() []log.Handler {
	...
	if global.conf.LogToFile {
		handlers = append(handlers,
			...
			fileHandler(fileOpts{lvl: log.LvlAction, format: entryFormatMono}),
			fileHandler(fileOpts{lvl: log.LvlAction, format: entryFormatColor}),
			fileHandler(fileOpts{lvl: log.LvlAction, format: entryFormatHtml}),
